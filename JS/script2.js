...
let cantidadCompras = prompt("Ingrese la cantiad de productos distintos que quiere comprar: \n- Mesa\n- Silla\n- Lampara\n- Lapices")
let precioTotal = 0;
...
let precioTotalConImpuestos = sumaIva(precioTotal)
    ...
    alert("Este es el precio total de tus compras: $" + precioTotalConImpuestos)
